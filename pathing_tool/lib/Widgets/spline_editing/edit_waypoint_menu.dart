                  ...
                  if (selectedWaypoint != null)
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          List<Waypoint> newWaypoints = [...widget.waypoints];
                          Waypoint save =
                              newWaypoints[widget.selectedWaypoint].copyWith();
                          newWaypoints[widget.selectedWaypoint] =
                              newWaypoints[widget.selectedWaypoint - 1]
                                  .copyWith(t: save.t);
                          newWaypoints[widget.selectedWaypoint - 1] =
                              save.copyWith(
                                  t: newWaypoints[widget.selectedWaypoint - 1]
                                      .t);
                          widget
                              .onWaypointSelected(widget.selectedWaypoint - 1);
                          widget.onWaypointsChanged(newWaypoints);
                        },
